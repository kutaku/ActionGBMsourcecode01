...
public class StageBossCtrl2 : MonoBehaviour
{
    [Header("ボスドラゴンオブジェクト")] public BossDoragon1 BossDoragonClearTrigger;
    ...
    void Update()
    {
         if (BossDoragonClearTrigger.isBossClear && !doClear)
        {
